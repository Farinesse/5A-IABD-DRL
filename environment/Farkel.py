...
class FarkleEnv:
    ...
    def state_description(self) -> np.ndarray:
        ...
        """
        # Padding pour avoir toujours 12 éléments
        current_state = np.zeros(12)  # Initialize with zeros
        ...
        current_state[3:5] = self.scores  # Pour 2 joueurs
        current_state[5:11] = self.dice_roll + [0] * (6 - len(self.dice_roll))  # Padding des dés
...
class FarkleDQNEnv(FarkleEnv):
    ...
    def score(self) -> float:
        """
        Retourne un score normalisé qui reflète la performance du joueur,
        avec 1 pour la victoire, -1 pour la défaite et 0 pour un match nul.
        """
